...
BLOG_AUTHOR = "gilgi"  # (translatable)
BLOG_TITLE = "gilgi.org"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://gilgi.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://gilgi.org/"
BLOG_EMAIL = "site@gilgi.org"
BLOG_DESCRIPTION = "official blog of the gilgi.org network"  # (translatable)

# errorpages plugin conf
...
#       (
#           (
#               ("http://spqr.gilgi.org/", "Roman Chickens"),
#               ("http://scootscanoe.gilgi.org", "Scoot's Canoe"),
#               ("http://sclabs.gilgi.org", "Scoot's Canoe Labs"),
#               ("http://status.gilgi.org", "Status")
#           ),
#           'gilgi.org Network'
#       ),
        ('http://status.gilgi.org', 'Network Status')
    ),
}
...
<form method="get" action="https://www.google.com/search" class="navbar-form navbar-right" role="search" _lpchecked="1">
